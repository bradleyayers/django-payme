...
class SecurePayReceiptFactory(models.Model, AbstractMixin):
...
SecurePayReceipt = None


def build_models(payment_class):
    global SecurePayReceipt
    class SecurePayReceipt(SecurePayReceiptFactory.construct(payment_class)):
        pass
    return [SecurePayReceipt]
