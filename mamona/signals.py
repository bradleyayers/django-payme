...
items_query = Signal(providing_args=['items'])
items_query.__doc__ = """
...
customer_query = Signal(providing_args=['customer'])
customer_query.__doc__ = """
...
urls_query = Signal(providing_args=['urls'])
urls_query.__doc__ = """
...
payment_query = Signal(providing_args=['order', 'payment'])
payment_query.__doc__ = """
