...
Example::
    ...
    >>> from payme.backends.securepay import settings
    >>> settings.URL
    sandbox = "https://vault.safepay.com.au/cgi-bin/test_payment.pl"

Values for these settings are configurable via the django-payme backend
settings in the project's ``settings.py``::
